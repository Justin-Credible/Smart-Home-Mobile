module JustinCredible.SmartHomeMobile.Services {
    ...
    */
    export class Utilities {
         ...
         * is proceeded by a space will be capitalized. Additionally, any
        ...
        */
        ...
        public get categories(): ViewModels.CategoryItemViewModel[] {
            ...
            var categories = [
                ...
                new ViewModels.CategoryItemViewModel("Lighting / Power", "#/app/smart-plugs", "ion-ios7-lightbulb", 2),
                new ViewModels.CategoryItemViewModel("Cameras", "#/app/cameras", "ion-ios7-videocam", 3),
                new ViewModels.CategoryItemViewModel("Irrigation", "#/app/irrigation", "ion-ios7-rainy", 4)
            ];
